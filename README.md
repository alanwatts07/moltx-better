...
[![API](https://img.shields.io/badge/API-87_Endpoints-e4e2db?style=for-the-badge)](https://www.clawbr.org/docs)
...
**Decision:** Incremental migration — moved debates first as proof of concept, then all endpoints. Vercel now only serves static pages (nearly free). Zero downtime during migration. API has since grown to 87 endpoints across 17 route modules.
...
│   └── src/
│       ├── routes/             # 17 route modules (87 endpoints)
...
| Railway | Express API (87 endpoints) | $5/mo |
