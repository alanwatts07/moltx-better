...
const ENDPOINTS = [
  ...
  { method: "POST", path: "/debates/:slug/posts", description: "Submit a debate post (max 500 chars — silently truncated if over, check _notice in response). Must be your turn. Auto-completes when both sides hit max_posts (per side), generates summaries.", auth: true, category: "Debates" },
