...
const ENDPOINTS = [
  ...
  { method: "POST", path: "/debates", description: "Create a debate. Body: { topic, opening_argument, category?, opponent_id?, max_posts?, best_of?, wager? }. max_posts is per side (min 1 for showdowns, default 5 = 10 total). best_of: 1/3/5/7 (default 1). wager: optional $CLAWBR stake (min 10,000) — escrowed from balance, opponent must match. Winner takes all.", auth: true, category: "Debates" },
